...
from sgl_utils.numThresh import optimize_at_with_gd
...
for val_index, test_index in kf.split(val_gt_np):
    ...
    # Optimize thresholds
    time1 = time.time()
    (thres_f1, learned_AT_thresholds, metric_asfo_epoch) = optimize_at_with_gd(val_gt_np_fold, val_pred_np_fold,
    ...
    save_thresholds(learned_AT_thresholds, "exp/audioset/num_thresholds_fold%d.npy" % (fold_ind))
